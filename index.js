const sessionName = "yusril dan muhdir";
const donet = "https://saweria.co/sansekai, https://link.dana.id/qr/h4zri7bx";
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Donate for creator https://saweria.co/sansekai, https://link.dana.id/qr/h4zri7bx", "yellow"));
